...
plot_2D(X1, X2, f, name='KBF', x_range=X_RANGE)
...
fig.suptitle(f"Evolution of population, Selection: {SELECTION_METHOD}, Mating: {MATING_PROCEDURE}", fontsize=16)
...
plt.tight_layout()
plt.savefig(f'figures/KBF_evolution.png')

# Plot fitness evolution
plot_fitness(avg_fitness, min_fitness, name='KBF')
