...
As with Section \ref{sec:CGA_selection_mutation}, the flexibility offered by PT was first explored using the parallelised experiments presented in code %placeholder
...
Each run was limited to a maximum of 10,000 function evaluations, and convergence was identified as the point where the $l_2$-normed difference between the minimum fitness values of consecutive iterations stayed within a tolerance of 0.00025 for 1300 consecutive iterations. This was deemed appropriate after the trial run depicted in Fig. \ref{fig:trial_fitness}.

\subsection{Trial}
\label{sec:trial}

Prior to the experiment, a trial run was conducted using one initialisation to assess the suitability of the convergence criterion, and to set expectations. 
\end{multicols}
\begin{table}[H]
    \centering
    \begin{tabular}{l|cccccc}
    \hline
    & Final Avg. Fitness & Final Min. Fitness & Total Time Taken & Iters to Convergence & Best Solution \\
    \hline
    CGA & -0.497066534 & -0.69007894 & 299.1920519 & 9349 & $[3.10370992, 3.02718856, 1.62447231, 0.5871856, 0.53627267, 0.61304027, 0.52941284, 0.48082145]$ \\
    PT & -0.464570219 & -0.708146655 & 592.6563666 & 11991 & $[3.11107738, 2.9479856, 3.07088851, 1.64256981, 0.3356233, 0.46361719, 0.42837701, 0.24570423]$ \\
    \hline
    \end{tabular}
    \caption{Trial comparison between CGA and PT, after 10,000 iterations with one shared initialisation.}
...
\begin{figure}[H]
    ...
    \end{subfigure}
\captionsetup{justification=centering}
\caption{Evolution of fitness values over 10,000 iterations for the CGA and PT algorithms, using a single initialisation as a trial run.}
