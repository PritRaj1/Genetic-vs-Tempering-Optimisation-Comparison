...
\begin{figure}[H]
    ...
    \end{subfigure}
    \captionsetup{justification=centering}
    \caption{Heat maps of the final fitness values after 100 iterations for the PT algorithm using stochastic exchange. Here, the power term and exchange parameter were varied to assess their impact on performance. The values varied greatly upon repitition.}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{../figures/Permanent Images/0.005_5_Periodic_Solutions.png}
    \captionsetup{justification=centering}
    \caption{Evolution of the convergence of the optimally-tuned PT solutions over 100 iterations. The best solution is circled in green. A particular solution within the final replica is also highlighted in yellow to aid visualisation of the MCMC sampling process.}
