...
\subsubsection{Tuning the Selection Method and Mutation Procedure}
...
\begin{table}[H]
    ...
    \begin{tabular}{|*{5}{c|}}
        ...
        & & & & \\
        \hline
        \multirow{4}{*}{Proportional} & \multirow{2}{*}{Crossover} & 10 & -0.2524 & -0.3056 \\
        & &\cellcolor{lightgray} 100 &\cellcolor{lightgray} -0.2776 &\cellcolor{lightgray} -0.3251 \\
        \cline{2-5}
        & \multirow{2}{*}{Heuristic Crossover} & 10 & -0.2070 & -0.2586 \\
        & &\cellcolor{lightgray} 100 &\cellcolor{lightgray} -0.2416 & \cellcolor{lightgray} -0.2612 \\
        \hline
        \multirow{4}{*}{Tournament} & \multirow{2}{*}{Crossover} & 10 & -0.0033 & -0.2104 \\
        & &\cellcolor{lightgray} 100 &\cellcolor{lightgray} -0.0026 &\cellcolor{lightgray} -0.1373 \\
        \cline{2-5}
        & \multirow{2}{*}{Heuristic Crossover} & 10 & -0.0047 & -0.1369 \\
        & &\cellcolor{lightgray} 100 &\cellcolor{lightgray} -0.0013 &\cellcolor{lightgray} -0.0641 \\
        \hline
        \multirow{4}{*}{SRS} & \multirow{2}{*}{Crossover} & 10 & -0.2852 & -0.3501 \\
        & &\cellcolor{lightgray} 100 &\cellcolor{lightgray} -0.3192 &\cellcolor{lightgray} -0.3443 \\
        \cline{2-5}
        & \multirow{2}{*}{Heuristic Crossover} & 10 & -0.2343 & -0.2629 \\
        & &\cellcolor{lightgray} 100 &\cellcolor{lightgray} -0.2306 &\cellcolor{lightgray} -0.2620 \\
        \hline
    \end{tabular}
